        ...
        routeInit: function (e) {
            var t = this, a = {
                ...
                routes: [{
                    ...
                    , {path: "/userlst", component: "/admin/User/lstView", name: "用户列表"}
                    , {path: "/codelst", component: "/admin/Code/lstView", name: "二维码列表"}
                    , {path: "/createcode", component: "/createcode", name: "创建二维码"}
                    , {path: "/grouplst", component: "/admin/Group/lstView", name: "组名列表"}
                    , {path: "/creategroup", component: "/creategroup", name: "创建组名"}
                    , {path: "/scanlst", component: "/admin/Scan/lstView", name: "扫描列表"}
                    // , {path: "/logout", component: "/admin/Login/logout", name: "退出登录"}
                    , {
                        path: "/baidu",
