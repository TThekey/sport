...
layui.define(["layer", "lodash", "laytpl", "utils"], function (t) {
    layui.layer;
    var i = layui.jquery, e = layui.lodash, l = layui.laytpl, a = layui.utils,
        ...
        return _createClass(t, [{
            key: "render", value: function (t) {
                i(void 0 === t ? "select.kit-select-target" : "select.kit-select-target[lay-filter=" + t + "]").each(function () {
                    var t = i(this), c = a.randomCode();
                    this.id = c, this.style.display = "none", console.log(t);
                    var r = this.multiple;
                    console.log(r), l(s.join("")).render({targetId: c}, function (e) {
                        t.after(e);
                        var a = i(".kit-select[kit-id=" + c + "]"), s = a.width(), r = a[0].clientHeight;
                    ...
                    e.forEach(this.children, function (t, i) {
                        o.push({value: t.value, text: t.innerText})
